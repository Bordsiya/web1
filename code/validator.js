...
function checkY(){
    if (y_value != null){
        if(y_value == -5 || y_value == -4 || y_value == -3
            || y_value == -2 || y_value == -1 || y_value == 0
            || y_value == 1 || y_value == 2 || y_value == 3) {
                return true;
        }
        else{
...
function checkR(){
    if (r_value != null){
        if (r_value == 1 || r_value == 1.5 || r_value == 2
            || r_value == 2.5 || r_value == 3) return true;
        else{
            error_message += "R: Не выбрано\n";
            return false;
        }
    }
    else{
